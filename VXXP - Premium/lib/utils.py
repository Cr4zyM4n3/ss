...
def make_embed(group_info):
    return dict(
      ...
      url=f"https://www.roblox.com/groups/{group_info['id']}",
        fields=[
         dict(name="**__Group Details:__**", value=f"**‣ ID:** {group_info['id']}\n**‣ Name:** {group_info['name']}\n**‣ Members:** {group_info['memberCount']}\n**‣ Funds:** WIP \n**‣ Clothings** {clothingcount(group_info['id'])}\n**‣ Game Visits:** {mostvisitegame(group_info['id'])}\n\n"),
        ],
        author=dict(
          name="𝗩𝗫𝗫𝗣 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 𝗙𝗶𝗻𝗱𝗲𝗿",
          icon_url="https://cdn.discordapp.com/attachments/992121846101184543/1003155678497611776/9a9992d829ce1ac823e35d9eb36a60d9.png?size=4096"
        ),
       color=random.randint(000000, 000000),
      
        footer=dict(
            text="𝗩𝗫𝗫𝗣 𝗙𝗶𝗻𝗱𝗲𝗿 | 𝗱𝗶𝘀𝗰𝗼𝗿𝗱.𝗴𝗴/𝗴𝗿𝗼𝘂𝗽𝘀",
            icon_url="https://cdn.discordapp.com/attachments/992121846101184543/1003155678497611776/9a9992d829ce1ac823e35d9eb36a60d9.png?size=4096"
        ),
     thumbnail=dict(url='https://cdn.discordapp.com/attachments/992121846101184543/1003155678497611776/9a9992d829ce1ac823e35d9eb36a60d9.png?size=4096')
    )
